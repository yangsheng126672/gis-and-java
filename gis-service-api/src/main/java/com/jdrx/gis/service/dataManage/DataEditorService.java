...
public class DataEditorService {
    ...
    public Boolean savaSharePointOnLine(ShareAddedPointDTO dto,Long userId, String token,String deptPath){
        try {
            ...
            //先删除gis_dev_ext原来管线
            gisDevExtPOMapper.deleteDevExtByDevId(dto.getLineDevId(),loginUserName,new Date());
            ...
            //先删除share_dev原来管线
            shareDevPOMapper.deleteByPrimaryKey(dto.getLineDevId(),loginUserName,new Date());
    ...
    public Boolean updateGISDevExtAttr(Map<String,Object> map,Long userId, String token) throws BizException{
        try {
            ...
            //更新gis_dev_ext中的material字段
            if(map.containsKey(GISConstants.GIS_ATTR_MATERIAL)){
